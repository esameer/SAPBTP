		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student31comsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student31comsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "student31comsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student31.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("student31/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
