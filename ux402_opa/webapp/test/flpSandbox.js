		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student31comsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student31comsaptrainingux402opaux402opa-display": {
								"semanticObject": "student31comsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student31.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student31/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
